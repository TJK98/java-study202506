...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // 무게가 100 이상이면서 빨강 사과만 필터링
        List<Apple> oneHundredOrRedApples = filterApples(appleBasket, apple -> apple.getWeight() >= 100 && apple.getColor() == RED);
        System.out.println("oneHundredOrRedApples = " + oneHundredOrRedApples);
