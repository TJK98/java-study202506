...
public class TypeCasting {
    ...
    public static void main(String[] args) {
        ...
        double m = 5.567;
        int n = (int) m; // 데이터 손실을 피할 수 없음, 소수점 버리기 할 때 사용하기도 함
        ...
        int h = 5;
        double result3 = 27.0 / (double) h;
        System.out.println("result3 = " + result3);

        // int보다 작은 데이터들(char, short, byte)은 연산 결과가 무조건 int다
        byte b1 = 100;
        byte b2 = 70;
        // byte result4 = b1 + b2;
        int result4 = b1 + b2;

        System.out.println('A' + 'C'); // AC (X), 132 (O)
